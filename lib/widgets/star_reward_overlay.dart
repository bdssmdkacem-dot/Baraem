    ...
    return Stack(
      ...
      children: [
        ConfettiWidget(
          ...
          maxBlastForce: 12,
          minBlastForce: 6,
          colors: const [AppColors.primaryGold, AppColors.primaryMint, AppColors.primaryCoral, AppColors.primarySky],
        ),
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('أحسنت! 🎉', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
              const SizedBox(height: 16),
              ElevatedButton(onPressed: widget.onDone, child: const Text('متابعة')),
            ],
          ),
        ),
      ],
